...
module.exports = class nHentai {
     ...
     * @return {object} nHentai list object
     */
    look(keyword, page=1, popular=false) {
    ...
    tag(keyword, page=1, popular=false) {
        ...
        let url = `${baseUrl}/tag/${keyword.replace(' ', '-')}/${popular ? 'popular' : ''}?${query}`;
    ...
    artist(keyword, page=1, popular=false) {
        ...
        let url = `${baseUrl}/artist/${keyword.replace(' ', '-')}/${popular ? 'popular' : ''}?${query}`;
    ...
    character(keyword, page=1, popular=false) {
        ...
        let url = `${baseUrl}/character/${keyword.replace(' ', '-')}/${popular ? 'popular' : ''}?${query}`;
    ...
    parody(keyword, page=1, popular=false) {
        ...
        let url = `${baseUrl}/parody/${keyword.replace(' ', '-')}/${popular ? 'popular' : ''}?${query}`;
    ...
    group(keyword, page=1, popular=false) {
        ...
        let url = `${baseUrl}/group/${keyword.replace(' ', '-')}/${popular ? 'popular' : ''}?${query}`;
