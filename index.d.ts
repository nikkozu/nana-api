...
export default class NanaApi {
     ...
     * @return {object} nHentai list object
     */
    look(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
     ...
     * @return {object} nHentai list object
     */
    tag(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
     ...
     * @return {object} nHentai list object
     */
    artist(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
     ...
     * @return {object} nHentai list object
     */
    character(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
     ...
     * @return {object} nHentai list object
     */
    parody(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
     ...
     * @return {object} nHentai list object
     */
    group(keyword: string, page?: number, popular?: boolean): Promise<nHentaiListObject>;
}